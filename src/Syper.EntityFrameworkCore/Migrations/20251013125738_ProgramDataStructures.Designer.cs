...
namespace Syper.Migrations
{
    ...
    [Migration("20251013125738_ProgramDataStructures")]
    partial class ProgramDataStructures
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Syper.ClientCoachSubscriptions.ClientCoachSubscription", b =>
                {
                    ...
                    b.ToTable("AppClientCoachSubscriptions", (string)null);
                });
            ...
            modelBuilder.Entity("Syper.Exercises.Exercise", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Syper.Programs.Program", b =>
                {
                    ...
                    b.ToTable("AppPrograms", (string)null);
                });
            ...
            modelBuilder.Entity("Syper.ScheduleActivities.ScheduleActivity", b =>
                {
                    ...
                    b.ToTable("AppScheduleActivities", (string)null);
                });
            ...
            modelBuilder.Entity("Syper.ScheduleDays.ScheduleDay", b =>
                {
                    ...
                    b.Property<Guid>("WeeklyScheduleId1")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Syper.WeeklySchedules.WeeklySchedule", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppWeeklySchedules", (string)null);
                });

            modelBuilder.Entity("Syper.WorkoutExercises.WorkoutExercise", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("WorkoutSectionId")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppWorkoutExercises", (string)null);
                });

            modelBuilder.Entity("Syper.WorkoutSections.WorkoutSection", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppWorkoutSections", (string)null);
                });

            modelBuilder.Entity("Syper.Workouts.Workout", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppWorkouts", (string)null);
                });
            ...
            modelBuilder.Entity("Syper.ScheduleActivities.ScheduleActivity", b =>
                {
                    ...
                    b.HasOne("Syper.Workouts.Workout", "Workout")
                        .WithMany()
            ...
            modelBuilder.Entity("Syper.ScheduleDays.ScheduleDay", b =>
                {
                    b.HasOne("Syper.WeeklySchedules.WeeklySchedule", null)
                        .WithMany("ScheduleDays")
                        .HasForeignKey("WeeklyScheduleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Syper.WeeklySchedules.WeeklySchedule", "WeeklySchedule")
                        .WithMany()
                        .HasForeignKey("WeeklyScheduleId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Syper.WorkoutExercises.WorkoutExercise", b =>
                {
                    b.HasOne("Syper.Exercises.Exercise", "Exercise")
                        .WithMany()
                        .HasForeignKey("ExerciseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Syper.WorkoutSections.WorkoutSection", "WorkoutSection")

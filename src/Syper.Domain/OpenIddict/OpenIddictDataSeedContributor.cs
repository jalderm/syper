...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("Syper") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "Syper", DisplayName = "Syper API", Resources = { "Syper" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        var consoleAndAngularClientId = configurationSection["Syper_App:ClientId"];
        ...
        // Swagger Client
        var swaggerClientId = configurationSection["Syper_Swagger:ClientId"];
